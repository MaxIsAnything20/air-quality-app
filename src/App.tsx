...
{/* Mframapa brand chrome — deep forest green, grounded in the
...
<span className="text-sm font-semibold text-white tracking-wide">Mframapa</span>
...
{screen === 'groups' && <GroupsView onBack={goBack} exposureScore={exposureScore} />}
