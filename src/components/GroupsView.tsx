...
/**
 * Groups is a social/comparison feature (compare exposure with friends or
 * a community) that has no backend yet — this is a UI-only placeholder
 * matching the reference app's own empty state, not a stubbed-out real
 * feature pretending to work.
 */
  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 text-center gap-3">
        ...
        <p className="text-sm font-medium text-ink-900 dark:text-night-100 m-0">No groups yet</p>
        <p className="text-xs text-ink-400 dark:text-night-400 m-0">
          Join or create a group to compare your exposure with friends.
        </p>
      </div>
    </div>
  )
